...
it.each([['classic','5faf2f30'],['d10','9067b567'],['d30','766ff6ef'],['d100','7405db17']] as const)('preserves seed 19 positions, cells, roofs, fixtures and slabs in %s', (district, expected) => {
