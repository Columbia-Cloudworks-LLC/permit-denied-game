...
it.each([['classic','5faf2f30'],['d10','90c04fbe'],['d30','636abbbe'],['d100','ed153d5b']] as const)('preserves seed 19 positions, cells, roofs, fixtures and slabs in %s', (district, expected) => {
