...
export const MENU_ICONS = {
  ...
  speaker: icon(
    'speaker',
    '<path d="M3.6 9.4h3.1L11.2 5.2v13.6l-4.5-4.2H3.6z"/><path d="M15.1 9.1a3.6 3.6 0 0 1 0 5.8"/><path d="M17.5 6.7a7 7 0 0 1 0 10.6"/>',
  ),
  speakerMuted: icon(
    'speaker-muted',
    '<path d="M3.6 9.4h3.1L11.2 5.2v13.6l-4.5-4.2H3.6z"/><circle cx="17.5" cy="12" r="4.7"/><path d="M14.4 15.3 20.6 8.7"/>',
  ),
  about: icon(
    'about',
